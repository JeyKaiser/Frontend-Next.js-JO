...
import DataTable from '@/app/globals/components/molecules/DataTable'; // Asegúrate de que este componente esté correctamente importado
import { TelaData, InsumoData, MdCreacionFichaData } from '@/app/modules/types'; 
