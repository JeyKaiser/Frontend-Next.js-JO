...
// // app/(dashboard)/referencia-detalle/[referenciaId]/page.tsx
// // Este es un Server Component que redirige a la primera fase.
...
// export default async function ReferenciaPage({ params }: ReferenciaPageProps) {
...
//       // Si no hay data o fases, el layout.tsx ya lanzará notFound.
//       // Esto es un fallback, aunque idealmente no debería ser alcanzado.
//       redirect(`/404`); // O a una página de error más específica
//     }

//     // Redirige a la primera fase disponible
//     const primeraFaseSlug = referenciaData.fases_disponibles[0].slug;
//     redirect(`/referencia-detalle/${referenciaId}/fases/${primeraFaseSlug}`);

//   } catch (error) {
//     console.error(`Error en page.tsx de detalle de referencia ${referenciaId}:`, error);
//     // El layout.tsx ya maneja el error con notFound, pero si algo falla aquí antes del layout
//     // puedes redirigir a una página de error genérica.
//     redirect(`/error`); // Asegúrate de tener un app/error.tsx o una ruta /error
//   }
// }