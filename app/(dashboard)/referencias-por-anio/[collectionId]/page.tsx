...
import type { ReferenciasAnioApiResponse } from '../../../modules/types/index';
...
// export default async function ReferenciasListPage({ params }: ReferenciasListPageProps) {
//   const { collectionId } = params; // Obtiene el ID del año/colección
//   console.log(`[ReferenciasListPage] Cargando referencias para collectionId: ${collectionId}`);
...
//           console.log(`[Referencias-por-anio] Generando enlace para ${modelo.U_GSP_REFERENCE}: ${destinationUrl} colectionId: ${collectionId}`);
