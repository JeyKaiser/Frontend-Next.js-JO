  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        console.log(`[ReferenciasListPage] Cargando referencias para collectionId: ${resolvedParams.collectionId}`);
        
        const data = await getReferenciasList(resolvedParams.collectionId);
        setModelos(data);
      } catch (err) {
